...
function(a) {
    var b = {
        initTree: function(b) {
            var c = a.extend({},
            this.treegrid.defaults, b);
            return this.each(function() {
                var b = a(this);
                b.treegrid("setTreeContainer", a(this)),
                b.treegrid("setSettings", c),
                c.getRootNodes.apply(this, [a(this)]).treegrid("initNode", c),
                b.treegrid("getRootNodes").treegrid("render")
            })
        },
        initNode: function(b) {
            return this.each(function() {
                var c = a(this);
                c.treegrid("setTreeContainer", b.getTreeGridContainer.apply(this)),
        ...
        initChangeEvent: function() {
            ...
            function() {
                var b = a(this);
                b.treegrid("render"),
                b.treegrid("getSetting", "saveState") && b.treegrid("saveState")
            }),
            b
        },
        initEvents: function() {
            var b = a(this);
            return b.on("collapse",
            function() {
                var b = a(this);
                b.removeClass("treegrid-expanded"),
                b.addClass("treegrid-collapsed")
            }),
            b.on("expand",
            function() {
                var b = a(this);
                b.removeClass("treegrid-collapsed"),
                b.addClass("treegrid-expanded")
            }),
            b
        },
        ...
        initExpander: function() {
            ...
            d = b.treegrid("getSetting", "expanderTemplate"),
            e = b.treegrid("getSetting", "getExpander").apply(this);
            return e && e.remove(),
            a(d).prependTo(c).click(function() {
        ...
        initIndent: function() {
            ...
            for (var c = b.treegrid("getSetting", "indentTemplate"), d = b.find(".treegrid-expander"), e = b.treegrid("getDepth"), f = 0; e > f; f++) a(c).insertBefore(d);
            return b
        },
        initState: function() {
            var b = a(this);
        ...
        expandAll: function() {
            var b = a(this);
            return b.treegrid("getRootNodes").treegrid("expandRecursive"),
            b
        },
        expandRecursive: function() {
            return a(this).each(function() {
                var b = a(this);
                b.treegrid("expand"),
                b.treegrid("isLeaf") || b.treegrid("getChildNodes").treegrid("expandRecursive")
            })
        },
        collapse: function() {
            return a(this).each(function() {
        ...
        collapseAll: function() {
            var b = a(this);
            return b.treegrid("getRootNodes").treegrid("collapseRecursive"),
            b
        },
//        collapseAll: function(leval) {
//        	 var b = a(this);
//        	 var c=b.treegrid("getRootNodes");
////        	if(isNaN(leval) && leval=="all"){
////        		 return c.treegrid("collapseRecursive");
////        	}else if(!isNaN(leval) && leval>0){
////        		
////        	}else{
//        		for(var i=0;i<c.length;i++){
//                	c.treegrid("getChildNodes").treegrid("collapseRecursive");
//                }
//        	//}
//        	  return true;
//        },
//        collapseDef: function() {
//            var b = a(this);
//            var c=b.treegrid("getRootNodes");
//            for(var i=0;i<c.length;i++){
//            	c.treegrid("getChildNodes").treegrid("collapseRecursive");
//            }
//            return true;//b.treegrid("getRootNodes").treegrid("collapseRecursive");
//        },
        collapseRecursive: function() {
            return a(this).each(function() {
                var b = a(this);
                b.treegrid("collapse"),
                b.treegrid("isLeaf") || b.treegrid("getChildNodes").treegrid("collapseRecursive")
            })
        },
        toggle: function() {
            var b = a(this);
            return b.treegrid(b.treegrid("isExpanded") ? "collapse": "expand"),
            b
        },
        render: function() {
            return a(this).each(function() {
                var b = a(this);
                b.treegrid("isOneOfParentsCollapsed") ? b.hide() : b.show(),
                b.treegrid("isLeaf") || (b.treegrid("renderExpander"), b.treegrid("getChildNodes").treegrid("render"))
            })
        },
